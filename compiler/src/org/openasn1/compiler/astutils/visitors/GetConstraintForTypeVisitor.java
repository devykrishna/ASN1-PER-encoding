...
import org.openasn1.codec.constraints.ConstraintExtension;
import org.openasn1.codec.constraints.ConstraintIntersection;
import org.openasn1.codec.constraints.ConstraintUnion;
import org.openasn1.codec.constraints.subtype.IntegerValueRangeConstraint;
import org.openasn1.codec.constraints.subtype.PermittedAlphabetConstraint;
import org.openasn1.codec.constraints.subtype.RestrictedCharacterValueRangeConstraint;
import org.openasn1.codec.constraints.subtype.SingleValueConstraint;
import org.openasn1.codec.constraints.subtype.ValueRangeConstraint;
import org.openasn1.codec.constraints.subtype.ValueRangeConstraint.Extrema;
import org.openasn1.compiler.astutils.ASN1ASTNodeInfos;
import org.openasn1.parser.generated.syntaxtree.BuiltinType;
import org.openasn1.parser.generated.syntaxtree.BuiltinValue;
import org.openasn1.parser.generated.syntaxtree.CharacterStringType;
import org.openasn1.parser.generated.syntaxtree.CharacterStringValue;
import org.openasn1.parser.generated.syntaxtree.ContainedSubtype;
import org.openasn1.parser.generated.syntaxtree.ElementSetSpecs;
import org.openasn1.parser.generated.syntaxtree.Elements;
...
import org.openasn1.parser.generated.syntaxtree.IntegerValue;
import org.openasn1.parser.generated.syntaxtree.IntersectionElements;
import org.openasn1.parser.generated.syntaxtree.Intersections;
import org.openasn1.parser.generated.syntaxtree.LowerEndValue;
import org.openasn1.parser.generated.syntaxtree.LowerEndpoint;
...
import org.openasn1.parser.generated.syntaxtree.ReferencedType;
import org.openasn1.parser.generated.syntaxtree.RestrictedCharacterStringType;
import org.openasn1.parser.generated.syntaxtree.RestrictedCharacterStringValue;
...
import org.openasn1.parser.generated.syntaxtree.TypeOrNamedType;
import org.openasn1.parser.generated.syntaxtree.Unions;
import org.openasn1.parser.generated.syntaxtree.UpperEndValue;
import org.openasn1.parser.generated.syntaxtree.UpperEndpoint;
import org.openasn1.parser.generated.syntaxtree.Value;
import org.openasn1.parser.generated.syntaxtree.ValueRange;
import org.openasn1.parser.generated.visitor.GJVoidDepthFirst;
...
public class GetConstraintForTypeVisitor extends GJVoidDepthFirst<Constraint> {
	...
	public void visit(SizeConstraint n, Constraint argu) {
		...
		Constraint sizeConstraint = new org.openasn1.codec.constraints.subtype.SizeConstraint(sizeVisitor.getConstraint());
	...
	private class ValueRangeEndpointVisitor extends NoTraversalVisitor {
		...
		public void visit(IntegerValue n) {
			...
			try {
				...
				setEndpointValue(Long.parseLong(n.signedNumber.nodeToken.tokenImage));
			} catch (Exception e) {
				setEndpointValue(Long.MAX_VALUE);
			}
		}
	}
	...
	public void visit(ValueRange n, Constraint argu) {
		...
		if (isLowerEndpointExtremum && isUpperEndpointExtremum) {
			...
			if (IntegerType.class.equals(getContainingType())) {
				valueRangeConstraint = new IntegerValueRangeConstraint((Extrema)lowerEndpointVisitor.getEndpointValue(), ((Number)upperEndpointVisitor.getEndpointValue()).longValue(), isLowerEndpointExcluded, isUpperEndpointExcluded);
			} else if(RestrictedCharacterStringType.class.equals(getContainingType())) {
			...
			if (IntegerType.class.equals(getContainingType())) {
				valueRangeConstraint = new IntegerValueRangeConstraint(((Number)lowerEndpointVisitor.getEndpointValue()).longValue(), (Extrema)upperEndpointVisitor.getEndpointValue(), isLowerEndpointExcluded, isUpperEndpointExcluded);
			} else if(RestrictedCharacterStringType.class.equals(getContainingType())) {
			...
			if (IntegerType.class.equals(getContainingType())) {
				valueRangeConstraint = new IntegerValueRangeConstraint(((Number)lowerEndpointVisitor.getEndpointValue()).longValue(), ((Number)upperEndpointVisitor.getEndpointValue()).longValue(), isLowerEndpointExcluded, isUpperEndpointExcluded);
			} else if(RestrictedCharacterStringType.class.equals(getContainingType())) {
