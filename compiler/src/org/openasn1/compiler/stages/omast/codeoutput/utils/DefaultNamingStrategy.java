 ...
 *
 */
public class DefaultNamingStrategy implements TypeNamingStrategy {
	private static DefaultNamingStrategy instance;
	
	static {
		instance = new DefaultNamingStrategy();
	}
	
	public static DefaultNamingStrategy getInstance()  {
		return instance;
	}
