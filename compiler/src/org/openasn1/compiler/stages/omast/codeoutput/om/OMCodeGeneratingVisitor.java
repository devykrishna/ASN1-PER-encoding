 ...
 * 
 */
package org.openasn1.compiler.stages.omast.codeoutput.om;
...
import org.openasn1.compiler.codeoutpututils.ClassInformationHolder;
...
public class OMCodeGeneratingVisitor extends AbstractOMVisitor {
	...
	static {
		typeMapping.put(SimpleASN1TypeEnum.INTEGER.name(), "Long");
		typeMapping.put(SimpleASN1TypeEnum.REAL.name(), "Double");
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.openasn1.compiler.omast.AbstractOMVisitor#visit(org.openasn1.compiler.omast.ASN1ImportListFromModule)
	 */
	@Override
	...
	/**
	 * @see org.openasn1.compiler.omast.AbstractOMVisitor#visit(org.openasn1.compiler.omast.ASN1Module)
	 */
	@Override
	...
	/**
	 * @see org.openasn1.compiler.omast.AbstractOMVisitor#visit(org.openasn1.compiler.omast.ASN1TypeAssignmentList)
	 */
	@Override
	...
	public void visit(ComplexASN1Type type) {
		...
		if (getTypeStack().isEmpty()) {
			...
			LOGGER.debug("generating ComplexType:Devy '" + javaType + "'");
			getTypeStack().push(classInformation);
			LOGGER.debug("generating ComplexType :devy'" + type.getAsn1Type().name() + "'");
			super.visit(type);
	...
	/**
	 * @see org.openasn1.compiler.omast.AbstractOMVisitor#visit(org.openasn1.compiler.omast.EnumASN1Type)
	 */
	@Override
