 ...
 * 
 */
package org.openasn1.compiler.codeoutpututils;
...
public final class ASN1ToJavaNameMapper {
	...
	static {
		...
		simpleTypeNameMapping.put(SimpleASN1TypeEnum.REAL, "Real");
		...
		simpleTypeMapping.put(SimpleASN1TypeEnum.INTEGER, "Long");
		simpleTypeMapping.put(SimpleASN1TypeEnum.REAL, "Double");
