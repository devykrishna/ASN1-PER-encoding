 ...
 * </PRE>
 */
public class RelativeOIDValue implements Node {
   private Node parent;
   public NodeToken nodeToken;
   public RelativeOIDComponentsList relativeOIDComponentsList;
   public NodeToken nodeToken1;

   public RelativeOIDValue(NodeToken n0, RelativeOIDComponentsList n1, NodeToken n2) {
      nodeToken = n0;
      if ( nodeToken != null ) nodeToken.setParent(this);
      relativeOIDComponentsList = n1;
      if ( relativeOIDComponentsList != null ) relativeOIDComponentsList.setParent(this);
      nodeToken1 = n2;
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
   }

   public RelativeOIDValue(RelativeOIDComponentsList n0) {
      nodeToken = new NodeToken("{");
      if ( nodeToken != null ) nodeToken.setParent(this);
      relativeOIDComponentsList = n0;
      if ( relativeOIDComponentsList != null ) relativeOIDComponentsList.setParent(this);
