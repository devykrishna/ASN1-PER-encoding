 ...
 * </PRE>
 */
public class ChoiceType implements Node {
   private Node parent;
   public NodeToken nodeToken;
   public NodeToken nodeToken1;
   public AlternativeTypeLists alternativeTypeLists;
   public NodeToken nodeToken2;

   public ChoiceType(NodeToken n0, NodeToken n1, AlternativeTypeLists n2, NodeToken n3) {
      nodeToken = n0;
      if ( nodeToken != null ) nodeToken.setParent(this);
      nodeToken1 = n1;
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
      alternativeTypeLists = n2;
      if ( alternativeTypeLists != null ) alternativeTypeLists.setParent(this);
      nodeToken2 = n3;
      if ( nodeToken2 != null ) nodeToken2.setParent(this);
   }

   public ChoiceType(AlternativeTypeLists n0) {
      nodeToken = new NodeToken("CHOICE");
      if ( nodeToken != null ) nodeToken.setParent(this);
      nodeToken1 = new NodeToken("{");
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
      alternativeTypeLists = n0;
      if ( alternativeTypeLists != null ) alternativeTypeLists.setParent(this);
