 ...
 * </PRE>
 */
public class DefinitiveIdentifier implements Node {
   private Node parent;
   public NodeToken nodeToken;
   public DefinitiveObjIdComponentList definitiveObjIdComponentList;
   public NodeToken nodeToken1;

   public DefinitiveIdentifier(NodeToken n0, DefinitiveObjIdComponentList n1, NodeToken n2) {
      nodeToken = n0;
      if ( nodeToken != null ) nodeToken.setParent(this);
      definitiveObjIdComponentList = n1;
      if ( definitiveObjIdComponentList != null ) definitiveObjIdComponentList.setParent(this);
      nodeToken1 = n2;
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
   }

   public DefinitiveIdentifier(DefinitiveObjIdComponentList n0) {
      nodeToken = new NodeToken("{");
      if ( nodeToken != null ) nodeToken.setParent(this);
      definitiveObjIdComponentList = n0;
      if ( definitiveObjIdComponentList != null ) definitiveObjIdComponentList.setParent(this);
