 ...
 * </PRE>
 */
public class EmbeddedPDVType implements Node {
   private Node parent;
   public NodeToken nodeToken;
   public NodeToken nodeToken1;

   public EmbeddedPDVType(NodeToken n0, NodeToken n1) {
      nodeToken = n0;
   ...
   public EmbeddedPDVType() {
      nodeToken = new NodeToken("EMBEDDED");
      if ( nodeToken != null ) nodeToken.setParent(this);
      nodeToken1 = new NodeToken("PDV");
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
   }
