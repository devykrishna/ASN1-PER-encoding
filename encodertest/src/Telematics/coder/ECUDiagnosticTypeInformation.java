...
public final class ECUDiagnosticTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private ECUDiagnosticTypeInformation() { }
	...
	public static class _ecuIDTypeInformation {
	...
	public static class _exceptionCodeTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class _dtcsTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class __dtcsTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(DiagnosticTroubleCodeTypeInformation.getTypeInformation().getConstraint());
		}
	}

	}

	public static class _diagnosticResultTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(HealthStatusTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(true);
			getTypeInformation().setConstraint(HealthStatusTypeInformation.getTypeInformation().getConstraint());
		}
	}
