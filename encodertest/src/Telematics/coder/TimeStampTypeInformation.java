...
public final class TimeStampTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private TimeStampTypeInformation() { }
	...
	static {
		...
		typeInformation.setConstraint(new IntegerValueRangeConstraint(0L, 9999999999999L));
	}
