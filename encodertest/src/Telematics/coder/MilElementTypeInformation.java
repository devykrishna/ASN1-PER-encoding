...
public final class MilElementTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private MilElementTypeInformation() { }
	...
	public static class _milTypeInformation {
		...
		static {
			...
			getTypeInformation().getTagList().addAll(MilCodeTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(MilCodeTypeInformation.getTypeInformation().getConstraint());
		}
	}
	...
	public static class _statusTypeInformation {
		...
		static {
			...
			getTypeInformation().getTagList().addAll(MilStatusTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(MilStatusTypeInformation.getTypeInformation().getConstraint());
		}
	}
