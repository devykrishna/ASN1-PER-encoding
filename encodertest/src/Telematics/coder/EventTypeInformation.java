...
public final class EventTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private EventTypeInformation() { }
	...
	public static class _eventPayloadTypeInformation {
		...
		static {
			...
			getTypeInformation().getTagList().add(new Tag(EXPLICIT, CONTEXT_SPECIFIC, 0));
			getTypeInformation().getTagList().addAll(EventPayloadTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(EventPayloadTypeInformation.getTypeInformation().getConstraint());
		}
	}
	...
	public static class _idTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(IdStringTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(IdStringTypeInformation.getTypeInformation().getConstraint());
		}
	}

	public static class _nameTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
