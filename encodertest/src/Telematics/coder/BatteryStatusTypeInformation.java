...
public final class BatteryStatusTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private BatteryStatusTypeInformation() { }
	...
	public static class _stateOfChargeTypeInformation {
		...
		static {
			...
			getTypeInformation().getTagList().addAll(StateOfChargeTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(StateOfChargeTypeInformation.getTypeInformation().getConstraint());
		}
	}

	public static class _chargeLevelTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(ChargeLevelTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(ChargeLevelTypeInformation.getTypeInformation().getConstraint());
		}
	}

	public static class _stateOfHealthTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(StateOfHealthTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(StateOfHealthTypeInformation.getTypeInformation().getConstraint());
		}
	}

	public static class _voltageTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
