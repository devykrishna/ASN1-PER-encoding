...
public final class Type2TypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<Type, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<Type, EnumeratedItemTypeInformation>();
	public static HashMap<Type, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private Type2TypeInformation() { }
	...
	static {
		...
		enumTypeMap.put(enumeration.journey, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.trip, new EnumeratedItemTypeInformation(false, 1));
