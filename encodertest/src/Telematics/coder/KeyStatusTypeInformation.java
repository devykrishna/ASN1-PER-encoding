...
public final class KeyStatusTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<KeyStatus, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<KeyStatus, EnumeratedItemTypeInformation>();
	public static HashMap<KeyStatus, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private KeyStatusTypeInformation() { }
	...
	static {
		...
		KeyStatus enumeration = null;
		enumTypeMap.put(enumeration.notInserted, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.inserted, new EnumeratedItemTypeInformation(false, 1));
