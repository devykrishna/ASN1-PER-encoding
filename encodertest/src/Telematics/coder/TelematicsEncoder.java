...
public class TelematicsEncoder extends TypeEncoder<Telematics> {
	public TelematicsEncoder(Telematics encodable, TypeInformation typeInformation) {
...
new HeaderEncoder(getEncodable().getHeader(), TelematicsTypeInformation._headerTypeInformation.getTypeInformation())
);
		componentEncoderList.add(
new BodyEncoder(getEncodable().getBody(), TelematicsTypeInformation._bodyTypeInformation.getTypeInformation())
);
