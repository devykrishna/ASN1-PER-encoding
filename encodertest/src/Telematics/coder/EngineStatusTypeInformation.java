...
public final class EngineStatusTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<EngineStatus, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<EngineStatus, EnumeratedItemTypeInformation>();
	public static HashMap<EngineStatus, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private EngineStatusTypeInformation() { }
	...
	static {
		...
		EngineStatus enumeration = null;
		enumTypeMap.put(enumeration.on, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.off, new EnumeratedItemTypeInformation(false, 1));
