...
public final class EngineBlockedStatusTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<EngineBlockedStatus, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<EngineBlockedStatus, EnumeratedItemTypeInformation>();
	public static HashMap<EngineBlockedStatus, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private EngineBlockedStatusTypeInformation() { }
	...
	static {
		...
		EngineBlockedStatus enumeration = null;
		enumTypeMap.put(enumeration.allowedToStart, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.forbiddenToStart, new EnumeratedItemTypeInformation(false, 1));
