...
public final class EngineOilPressureWarningTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<EngineOilPressureWarning, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<EngineOilPressureWarning, EnumeratedItemTypeInformation>();
	public static HashMap<EngineOilPressureWarning, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private EngineOilPressureWarningTypeInformation() { }
	...
	static {
		...
		EngineOilPressureWarning enumeration = null;
		enumTypeMap.put(enumeration.normal, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.warning, new EnumeratedItemTypeInformation(false, 1));
