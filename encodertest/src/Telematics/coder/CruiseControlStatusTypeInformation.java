...
public final class CruiseControlStatusTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<CruiseControlStatus, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<CruiseControlStatus, EnumeratedItemTypeInformation>();
	public static HashMap<CruiseControlStatus, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private CruiseControlStatusTypeInformation() { }
	...
	static {
		...
		CruiseControlStatus enumeration = null;
		enumTypeMap.put(enumeration.cruiseControlEnabled, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.cruiseControlDisabled, new EnumeratedItemTypeInformation(false, 1));
