...
public final class DrivingBehaviorTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private DrivingBehaviorTypeInformation() { }
	...
	public static class _behavioursTypeInformation {
		...
		static {
			...
			getTypeInformation().getTagList().addAll(BehavioursTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(BehavioursTypeInformation.getTypeInformation().getConstraint());
		}
	}
	...
	public static class _brakePedalDepressedTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class _engineSpeedTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class _transimissionGearPostionTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(TransimissionGearPostionTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(true);
			getTypeInformation().setConstraint(TransimissionGearPostionTypeInformation.getTypeInformation().getConstraint());
		}
	}

	public static class _cruiseControlStatusTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(CruiseControlStatusTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(true);
			getTypeInformation().setConstraint(CruiseControlStatusTypeInformation.getTypeInformation().getConstraint());
		}
	}
