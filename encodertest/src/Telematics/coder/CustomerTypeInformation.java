...
public final class CustomerTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private CustomerTypeInformation() { }
	...
	public static class _passengersTypeInformation {
	...
	public static class __passengersTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().setConstraint(PassengersTypeInformation.getTypeInformation().getConstraint());
		}
	}
