...
public final class PassengersTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private PassengersTypeInformation() { }
	...
	public static class _contactTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(ContactTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(ContactTypeInformation.getTypeInformation().getConstraint());
		}
	}
