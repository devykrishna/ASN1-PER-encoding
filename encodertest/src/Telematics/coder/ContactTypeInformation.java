...
public final class ContactTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<Contact, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<Contact, EnumeratedItemTypeInformation>();
	public static HashMap<Contact, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private ContactTypeInformation() { }
	...
	static {
		...
		Contact enumeration = null;
		enumTypeMap.put(enumeration.notContact, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.contact, new EnumeratedItemTypeInformation(false, 1));
