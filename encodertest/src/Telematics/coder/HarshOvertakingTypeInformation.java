...
public final class HarshOvertakingTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private HarshOvertakingTypeInformation() { }
	...
	public static class _distancefromOvertookVehicleTypeInformation {
	...
	public static class _acceleratingDurationTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class _dfbSpeedTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class _pointsTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
	...
	public static class __pointsTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().setConstraint(PositionNSpeedTypeInformation.getTypeInformation().getConstraint());
		}
	}
