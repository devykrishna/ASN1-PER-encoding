...
public final class EngineCoolantLevelStatusTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<EngineCoolantLevelStatus, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<EngineCoolantLevelStatus, EnumeratedItemTypeInformation>();
	public static HashMap<EngineCoolantLevelStatus, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private EngineCoolantLevelStatusTypeInformation() { }
	...
	static {
		...
		EngineCoolantLevelStatus enumeration = null;
		enumTypeMap.put(enumeration.high, new EnumeratedItemTypeInformation(false, 0));
