...
public class TheftEncoder extends TypeEncoder<Theft> {
	public TheftEncoder(Theft encodable, TypeInformation typeInformation) {
...
new PositionEncoder(getEncodable().getPosition(), TheftTypeInformation._positionTypeInformation.getTypeInformation())
);
		componentEncoderList.add(
new RealEncoder(getEncodable().getOdometer(), TheftTypeInformation._odometerTypeInformation.getTypeInformation())
);
