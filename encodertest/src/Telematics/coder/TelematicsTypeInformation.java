...
public final class TelematicsTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private TelematicsTypeInformation() { }
	...
	public static class _headerTypeInformation {
		...
		static {
			...
			getTypeInformation().getTagList().addAll(HeaderTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(HeaderTypeInformation.getTypeInformation().getConstraint());
		}
	}

	public static class _bodyTypeInformation {
		private static TypeInformation typeInformation = new TypeInformation();
		...
		static {
			...
			getTypeInformation().getTagList().addAll(BodyTypeInformation.getTypeInformation().getTagList());
			getTypeInformation().setExtensible(false);
			getTypeInformation().setOptional(false);
			getTypeInformation().setConstraint(BodyTypeInformation.getTypeInformation().getConstraint());
		}
	}
