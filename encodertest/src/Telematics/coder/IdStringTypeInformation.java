...
public final class IdStringTypeInformation {
	static private TypeInformation typeInformation;
	
	
	
	private IdStringTypeInformation() { }
	...
	static {
		...
		//typeInformation.setConstraint(new PermittedAlphabetConstraint(new ConstraintUnion(new RestrictedCharacterValueRangeConstraint('A', 'Z'), new RestrictedCharacterValueRangeConstraint('a', 'z'), new SingleValueConstraint<String>(" "), new SingleValueConstraint<String>("_"), new SingleValueConstraint<String>("-"), new RestrictedCharacterValueRangeConstraint('0', '9'))));
	}
