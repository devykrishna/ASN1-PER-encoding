...
public class TimeStampEncoder extends TypeEncoder<TimeStamp> {
	public TimeStampEncoder(TimeStamp encodable, TypeInformation typeInformation) {
	...
	public void encode(ASN1Encoder encoder) throws IOException {
		...
		encoder.encodeAsInteger(getEncodable().getTimeStamp(), getTypeInformation());
