...
public final class UsageModeTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<UsageMode, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<UsageMode, EnumeratedItemTypeInformation>();
	public static HashMap<UsageMode, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private UsageModeTypeInformation() { }
	...
	static {
		...
		UsageMode enumeration = null;
		enumTypeMap.put(enumeration.odometerFromVehicle, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.odometerFromOBD, new EnumeratedItemTypeInformation(false, 1));
