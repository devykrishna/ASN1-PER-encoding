...
public final class BulbStatusTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<BulbStatus, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<BulbStatus, EnumeratedItemTypeInformation>();
	public static HashMap<BulbStatus, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private BulbStatusTypeInformation() { }
	...
	static {
		...
		BulbStatus enumeration = null;
		enumTypeMap.put(enumeration.normal, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.abnormal, new EnumeratedItemTypeInformation(false, 1));
