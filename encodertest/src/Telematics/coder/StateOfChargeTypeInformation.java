...
public final class StateOfChargeTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<StateOfCharge, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<StateOfCharge, EnumeratedItemTypeInformation>();
	public static HashMap<StateOfCharge, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private StateOfChargeTypeInformation() { }
	...
	static {
		...
		StateOfCharge enumeration = null;
		enumTypeMap.put(enumeration.normal, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.alternated, new EnumeratedItemTypeInformation(false, 1));
