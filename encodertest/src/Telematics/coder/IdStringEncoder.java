...
public class IdStringEncoder extends TypeEncoder<IdString> {
	public IdStringEncoder(IdString encodable, TypeInformation typeInformation) {
	...
	public void encode(ASN1Encoder encoder) throws IOException {
		...
		encoder.encodeAsVisibleString(getEncodable().getIdString(), getTypeInformation());
