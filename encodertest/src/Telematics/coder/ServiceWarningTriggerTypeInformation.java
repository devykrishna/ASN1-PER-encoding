...
public final class ServiceWarningTriggerTypeInformation {
	static private TypeInformation typeInformation;
	static private HashMap<ServiceWarningTrigger, EnumeratedItemTypeInformation> enumTypeMap = new HashMap<ServiceWarningTrigger, EnumeratedItemTypeInformation>();
	public static HashMap<ServiceWarningTrigger, EnumeratedItemTypeInformation> getEnumTypeMap() { return enumTypeMap; }
	
	private ServiceWarningTriggerTypeInformation() { }
	...
	static {
		...
		ServiceWarningTrigger enumeration = null;
		enumTypeMap.put(enumeration.enabled, new EnumeratedItemTypeInformation(false, 0));
		enumTypeMap.put(enumeration.disabled, new EnumeratedItemTypeInformation(false, 1));
