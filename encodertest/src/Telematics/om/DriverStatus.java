...
public class DriverStatus extends Object {
	public DriverStatus() {
	}
	...
	public boolean equals(Object anObject) {
		...
		DriverStatus comparator = (DriverStatus)anObject;
	...
	public int hashCode() {
		...
		hash = 157 * hash + (null == this.getPosition() ? 0 : this.getPosition().hashCode());
		hash = 6427 * hash + (null == this.getDriverId() ? 0 : this.getDriverId().hashCode());
		hash = 3089 * hash + (null == this.getDriverName() ? 0 : this.getDriverName().hashCode());
		return hash;
	}
