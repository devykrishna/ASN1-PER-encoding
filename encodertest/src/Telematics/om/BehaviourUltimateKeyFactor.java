...
public class BehaviourUltimateKeyFactor extends Object {
	public BehaviourUltimateKeyFactor() {
	}
	...
	public boolean equals(Object anObject) {
		...
		BehaviourUltimateKeyFactor comparator = (BehaviourUltimateKeyFactor)anObject;
	...
	public int hashCode() {
		...
		hash = 5573 * hash + (null == this.getPeakValue() ? 0 : this.getPeakValue().hashCode());
		hash = 2767 * hash + (null == this.getThreshold() ? 0 : this.getThreshold().hashCode());
		hash = 2833 * hash + (null == this.getDurationOverThreshold() ? 0 : this.getDurationOverThreshold().hashCode());
		hash = 199 * hash + (null == this.getDfbSpeed() ? 0 : this.getDfbSpeed().hashCode());
		return hash;
	}
