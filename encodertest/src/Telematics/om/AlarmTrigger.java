...
public class AlarmTrigger extends Object {
	public AlarmTrigger() {
	}
	...
	public boolean equals(Object anObject) {
		...
		AlarmTrigger comparator = (AlarmTrigger)anObject;
	...
	public int hashCode() {
		...
		hash = 4637 * hash + (null == this.getPosition() ? 0 : this.getPosition().hashCode());
		hash = 6257 * hash + (null == this.getDriverId() ? 0 : this.getDriverId().hashCode());
		hash = 773 * hash + (null == this.getDriverName() ? 0 : this.getDriverName().hashCode());
		hash = 4651 * hash + (null == this.getSpeed() ? 0 : this.getSpeed().hashCode());
		hash = 6977 * hash + (null == this.getOdometer() ? 0 : this.getOdometer().hashCode());
		return hash;
	}
