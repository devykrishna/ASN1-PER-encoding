...
import org.openasn1.codec.constraints.subtype.SizeConstraint;
 ...
 *
 */
public class PERIntegerSizeConstraintVisitor extends PERVisibleConstraintVisitor {
	...
	public PERIntegerSizeConstraintVisitor(ConstraintVisitorImpl parentConstraintVisitor) {
	...
	public boolean hasConstrainedRootMinimum() {
		...
		PERIntegerSizeConstraintVisitor parentVisitor = (PERIntegerSizeConstraintVisitor)getAncientVisitorWhoVisited(PERIntegerSizeConstraintVisitor.class, ConstraintSerialisation.class);
	...
	public Long getConstrainedMinimum() {
	...
	public Long getConstrainedRootMinimum() {
		if (! hasEffectiveSizeConstraint()) {
	...
	public Long getConstrainedAdditionMinimum() {
		if (! hasEffectiveExtensionAdditionSizeConstraint()) {
	...
	public Long getConstrainedMaximum() {
	...
	public Long getConstrainedRootMaximum() {
		if (! hasEffectiveSizeConstraint()) {
	...
	public Long getConstrainedAdditionMaximum() {
		if (! hasEffectiveExtensionAdditionSizeConstraint()) {
	...
	private Long getMinimumRootSize() {
		if (hasConstrainedRootMinimum()) {
			return getConstrainedRootMinimum();
		}
	...
	private Long getMinimumAdditionSize() {
	...
	private Long getMaximumRootSize() {
		if (hasConstrainedRootMaximum()) {
			return getConstrainedRootMaximum();
		}
	...
	private Long getMaximumAdditionSize() {
	...
	/**
	 * @see org.openasn1.codec.constraints.visitor.DefaultConstraintVisitor#visit(org.openasn1.codec.constraints.subtype.SizeConstraint)
	 */
	@Override
	public void visit(SizeConstraint constraint) {
		super.visit(constraint);

		PERIntegerSizeConstraintVisitor visitor = new PERIntegerSizeConstraintVisitor(this);
	...
	/**
	 * @see org.openasn1.codec.constraints.visitor.DefaultConstraintVisitor#visit(org.openasn1.codec.constraints.subtype.SingleValueConstraint)
	 */
	@Override
	public <T> void visit(SingleValueConstraint<T> constraint) {
		super.visit(constraint);

		setEffectiveExtensionRootSizeConstraint(new IntegerValueRangeConstraint((Long)constraint.getValue(), (Long)constraint.getValue()));
	}
	...
	private IntegerValueRangeConstraint performUnion(IntegerValueRangeConstraint rangeA, IntegerValueRangeConstraint rangeB) {
		Long unionMinimum = null;
		Long unionMaximum = null;
	...
	private IntegerValueRangeConstraint performIntersection(IntegerValueRangeConstraint rangeA, IntegerValueRangeConstraint rangeB) {
		Long intersectionMinimum = null;
		Long intersectionMaximum = null;
	...
	public void visit(ConstraintUnion constraint) {
		...
		for (Constraint subConstraint : constraint.getList()) {
			PERIntegerSizeConstraintVisitor constraintVisitor = new PERIntegerSizeConstraintVisitor(this);
	...
	private IntegerValueRangeConstraint getRootIntegerValueRangeConstraint(PERIntegerSizeConstraintVisitor constraintVisitor) {
	...
	private IntegerValueRangeConstraint getAdditionIntegerValueRangeConstraint(PERIntegerSizeConstraintVisitor constraintVisitor) {
	 ...
	 * @see org.openasn1.codec.constraints.visitor.SimpleConstraintVisitor#visit(org.openasn1.codec.constraints.ConstraintList)
	 */
	@Override
	 ...
	 * @see org.openasn1.codec.constraints.visitor.DefaultConstraintVisitor#visit(org.openasn1.codec.constraints.ConstraintExcept)
	 */
	@Override
	public void visit(ConstraintExcept constraint) {
		super.visit(constraint);
		
		PERIntegerSizeConstraintVisitor operandAVisitor = new PERIntegerSizeConstraintVisitor(this); 
	...
	/**
	 * @see org.openasn1.codec.constraints.visitor.ConstraintVisitorImpl#visit(org.openasn1.codec.constraints.subtype.ExtensibleConstraint)
	 */
	@Override
	public void visit(ConstraintExtension constraint) {
		super.visit(constraint);
		
		PERIntegerSizeConstraintVisitor rootVisitor = new PERIntegerSizeConstraintVisitor(this); 
		PERIntegerSizeConstraintVisitor additionVisitor = new PERIntegerSizeConstraintVisitor(this); 
