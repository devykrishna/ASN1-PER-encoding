 ...
 * 
 */
package org.openasn1.codec.util.converter;
...
public class HexConverter {
	...
	public static String encode(final byte[] byteArray) {
		...
		for (final byte item : byteArray) {
			//System.out.print("HEXconverter : encode-byteArray "+ item+"\n");
			buffer.append(HexConverter.toHex(item));
		}
		//System.out.print("HEXconverter : encode "+ buffer.toString()+"\n");
	...
	private static String toHex(final byte item) {
		//System.out.print("HEXconverter : toHex item "+ item+"\n");
		int value = item;
		//System.out.print("HEXconverter : toHex value1 "+ value+"\n");
		value &= 0x000000ff;
		//System.out.print("HEXconverter : toHex value2 "+ value+"\n");
