...
public class StaticBitField extends BitFieldImpl {
	...
	public void setValue(int startBit, int endBit, long value) {
		//System.out.print("StaticBitField: setValue :  value "+value +"\n");
		//System.out.print("StaticBitField: setValue :  startBit "+startBit +"\n");
		//System.out.print("StaticBitField: setValue :  endBit "+endBit +"\n");
		if (startBit < 0) {
			throw new IndexOutOfBoundsException("The bit indices may not be negative");
		}
		...
		if ((endBit - startBit) > 63) { //31 chnaged to 63
	...
	public void setValue(int startBit, int endBit, int value) {
		throw new IndexOutOfBoundsException("StaticBitfield: setvalue not implemented");
