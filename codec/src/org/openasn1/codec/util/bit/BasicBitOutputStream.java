...
public class BasicBitOutputStream implements BitOutputStream {
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#writeBytes(byte[])
	 */
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#writeBytePartly(byte, int, int)
	 */
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#writeByte(byte)
	 */
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#writeByteCompact(byte)
	 */
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#writeBits(org.openasn1.codec.util.bit.BitField)
	 */
	synchronized public void writeBits(BitField bitField) throws IOException {
		for (int i = 0; i < bitField.getSize(); i++) {
			...
			//System.out.print(bitField.getBit(i) +"\n");
		}
	}

	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#writeBit(int)
	 */
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#flush()
	 */
	...
	/**
	 * @see org.openasn1.codec.util.bit.BitOutputStream#close()
	 */
