 ...
 * 
 */
package org.openasn1.codec.util;
...
public final class ASN1Constants {
	...
	public static final long SIZE_FOUR_OCTETS = 4294967296L;
	/*-----------------------addng 8 byte support------------------*/
	public static final long SIZE_FIVE_OCTETS = SIZE_FOUR_OCTETS << 8;
	public static final long SIZE_SIX_OCTETS = SIZE_FOUR_OCTETS << 16;
	public static final long SIZE_SEVEN_OCTETS = SIZE_FOUR_OCTETS << 24;
	public static final long SIZE_EIGHT_OCTETS = 9223372036854775807L;
	/*--------------------------------------------------------------*/
